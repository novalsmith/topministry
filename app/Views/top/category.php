				...
				<div class="modal-body">
                    ...
                    v-model="CategoryName" name="categoryname" autocomplete="off" placeholder="Category Name">
						...
						<div class="form-group" id="StatusPage" v-show="isUpdate">
							...
							<select name="statusCategory" class="form-control" v-model="statusCategory" id="statusCategory"></select>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" id="saveAddCategory" v-on:click="create" v-show="!isUpdate" class="btn btn-primary btn-md pl--20 ladda-button" data-style="zoom-out">
							<i class="fa fa-floppy-o"></i> Save
						</button>
						<button type="button" id="saveUpdateCategory" v-on:click="UpdateAction" v-show="isUpdate" class="btn btn-primary btn-md pl--20 ladda-button" data-style="zoom-out">
							<i class="fa fa-floppy-o"></i> Save
						</button>
					...
					<div class="HidePage" id="CategoryPage">
						<div class="mb-1">
							<div class="row m-2 col-md-12">
								<h4 class="text text-muted">Kategori</h4>
							</div>
