        ...
        <form id="FormAccount">
          <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" id="nama"
                ...
                <div class="col">
                    ...
                    <span id="emailValidateError" class="text text-danger HidePage mt-2"></span>
            ...
            <?php if(session()->get('roles')==1): ?>
                <div class="col">
                      <div class="form-group" id="rolePage" >
            ...
            <div class="col-md-12">
            <div class="form-group" id="StatusPage">
                <label for="">Password</label>

              <div v-show="isUpdate">
              <small class="text text-muted">Jika lupa atau ingin mengubah password, silahkan klik link dibawah ini.</small> <br/>
              <a class="cursorPointer" v-on:click="changePassword"  id="changePassword" href="javascript:void(0)">Lupa Password ?</a>
              </div>

              <div v-show="!isUpdate">
              <input type="password" maxlength="10" class="form-control form-control-alternative"  id="password"
          ...
          <div class="modal-content">
            ...
            <div class="row">
                <div class="col">
                      <div class="form-group">
                          <label for="">Password</label>
                          <input type="password" v-model="isChangePassword" require="required" maxlength="10" class="form-control form-control-alternative"  id="changePassword"
                          name="changePassword" autocomplete="off" placeholder="password">
                      </div>
                </div>
            </div>
        <!-- </div> -->
            ...
            <div class="modal-footer">
            <button type="button" id="updatePassword" v-on:click="UpdateChangePassword" class="btn btn-primary btn-md pl--20 ladda-button" data-style="zoom-out"><i class="fa fa-floppy-o"></i> Save</button>
            <button type="button" id="close"  data-dismiss="modal" class="btn btn-secondary btn-md pl--20 ladda-button" data-style="zoom-out"><i class="fa fa-ban"></i> Close</button>
            </div>
          </div>
          </form>
        </div>
...
<!-- End Confirm Delete -->
        ...
        <div class="col-md-12 HidePage mt-2" id="alertMessagePage">
         ...
         <div class="HidePage" id="CategoryPage">  
              <div class="mb-1">
                  ...
                  <h4 class="text text-muted">Akun</h4>
              </div>
    ...
    <script src="<?php echo base_url("top/assets/js/account.js?v=").JsandCssVersion ?>"></script>